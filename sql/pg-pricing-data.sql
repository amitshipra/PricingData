...
DROP DATABASE "EquityPrices";
--
-- Name: EquityPrices; Type: DATABASE; Schema: -; Owner: -
--

CREATE DATABASE "EquityPrices" WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'English_United States.1252' LC_CTYPE = 'English_United States.1252';


\connect "EquityPrices"
